...
class ServicesPage extends StatefulWidget {
  ...
  final String textService6 =
      ...
      " mas é possível recuperar tal dano a pele.\n\n Cabe salientar que cada procedimento clínico tem indicação conforme consulta prévia. \n\n"
  ...
  final String textService9 =
      "Eliminar o famoso queixo duplo é o sonho de muitas pessoas. Homens e mulheres se sentem incomodados com a gordura na região do pescoço e muitas vezes, "
      "deixam de tirar fotos, possuem baixa autoestima e sempre estão com a impressão de que estão acima do peso mesmo diante de rigorosas dietas.\n\n"
      "Com isso, o procedimento de lipoaspiração da papada tem sido bastante procurado ultimamente. Esse procedimento é pouco invasivo,"
      "sem riscos e possui um pós-operatório tranquilo, caso o paciente siga as recomendações.\n\n"
      "Trata-se da inserção de uma cânula com solução de Klein (tendo por base o soro fisiológico),"
      "para quebrar a gordura, com posterior sucção. O resulto é um pescoço lisinho, sem gordura, ângulos da mandíbula com maior definição,"
      "favorecendo para melhores destaques dos traços faciais e rejuvenescimento.\n\n"
      "O procedimento dura cerca de 30 a 60 minutos e pode ser feito nos pacientes a partir dos 18 anos. "
      "Apesar de ser notável uma mudança da face logo após o procedimento, os melhores resultados são percebidos após 3 meses.";
  ...
  Widget build(BuildContext context) {
    ...
    List<Widget> children = [
      ...
      ServiceContainer(
        ...
        img: Image.asset("assets/images/serviços/bioestimuladores2.jpg"),
        imgLeft: false,
      ),
      ServiceContainer(
        title: "PEELING ",
        text: widget.textService4,
        img: Image.asset("assets/images/serviços/peeling2.jpg"),
        imgLeft: true,
      ),
      ServiceContainer(
        title: "MICROAGULHAMENTO",
        text: widget.textService5,
        img: Image.asset("assets/images/serviços/microagulhamento2.jpg"),
        imgLeft: false,
      ),
      ServiceContainer(
        title: "O BOTOX E SUA AÇÃO NAS RUGAS ",
        text: widget.textService6,
        img: Image.asset("assets/images/serviços/botox2.jpg"),
        imgLeft: true,
      ),
      ServiceContainer(
        title: "PREENCHIMENTO COM ÁCIDO HIALURÔNICO ",
        text: widget.textService7,
        img: Image.asset("assets/images/serviços/preenchimento2.jpg"),
        imgLeft: false,
      ),
      ServiceContainer(
        title: "BICHECTOMIA ",
        text: widget.textService8,
        img: Image.asset("assets/images/serviços/bichectomia2.jpg"),
        imgLeft: true,
      ),
      ServiceContainer(
        title: "LIPOASPIRAÇÃO DE PAPADA",
        text: widget.textService9,
        img: Image.asset("assets/images/serviços/lipopapada.png"),
        imgLeft: false,
      ),
